    ...
    return (
        <section className='w-full mt-20'>
            <div className='max-w-7xl mx-auto px-6'>
                <div className="flex flex-col md:flex-row gap-6 md:h-130">
                    <div 
                    ...
                    >
                        <div>
                            ...
                            <p className='mt-4'>Position Absolute Acı Burger</p>
                            
                        </div>
                        <br />
                        <button className='z-10 bg-[#FAF7F2] text-red-600 rounded-full px-8 py-3 w-fit font-semibold'>SİPARİŞ VER</button>
                    ...
                    <div className='md:w-1/2 w-full flex flex-col gap-6'>
                        ...
                        >
                            ...
                            <button className='bg-[#FAF7F2] text-red-600 rounded-full px-5 py-2 text-sm font-semibold'>SİPARİŞ VER</button>
                        </div>
                        <div 
